    ...
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <motion.div
          ...
          animate="visible"
          variants={container}
          className="mt-12 container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-12 md:gap-20 place-items-center px-6 md:px-[5.5rem]"
        >
          {loading ? (
        ...
        <div className="text-white container mx-auto px-16 mt-8 flex items-center gap-4 md:justify-end justify-center ">
          <button
            className={`${page === 1 ? "text-gray-500" : ""}`}
            disabled={page === 1}
            onClick={() => setPage(1)}
